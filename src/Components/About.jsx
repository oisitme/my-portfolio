            ...
            >
                ...
                <div className="p-8 md:mt-6"> {/* paragraph container starts from here */}
                    ...
                    <div className="text-white max-h-28 md:max-h-full overflow-y-auto p-2 text-base mt-4 scale-95 md:scale-100 text-justify border border-white/20 md:mt-5">
                        <p>
                            I am Raushan Kumar, a computer engineering student and Full Stack Developer with hands-on experience building
                            scalable, production-ready web applications. My core expertise spans the MERN stack — React.js,
                            Node.js, Express.js, and MongoDB — complemented by a strong eye for design
                            using Tailwind CSS. I approach every project with a problem-first mindset,
